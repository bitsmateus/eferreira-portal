...
import { LIMITE_DA_LISTA, contarCasos, listarCasos } from '@/lib/casos'
        ...
        {lista.truncada && (
          <div className="aviso aviso-atencao mt-4">
            ...
            <div>
              ...
              recentes de {total}. Use a busca por número do processo, assunto ou
              cliente para chegar aos demais.
            </div>
          </div>
        )}
      </div>
